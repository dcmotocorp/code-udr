...
class SSHScreen:
    def __init__(self, screen_height, screen_width,app):
        ...
        self.labels = ["[0] enable", "[1] disable"]
    ...
    def setup_hostname_screen(self):
        ...
        self.auth_bottom_win.addstr(5, 25, label_text_bottom_esc, curses.color_pair(3))

        label_text_bottom_enter_ok = "<Enter> Ok"
        self.auth_bottom_win.addstr(5, 11, label_text_bottom_enter_ok, curses.color_pair(3))
